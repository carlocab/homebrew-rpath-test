class LlvmBootstrapped < Formula
  ...
  keg_only "this formula is only designed for testing"

  # https://llvm.org/docs/GettingStarted.html#requirement
  # We intentionally use Make instead of Ninja.
  # See: Homebrew/homebrew-core/issues/35513
  depends_on "carlocab/rpath-test/llvm-bootstrap-profdata" => :build
  ...
  def install
    ...
    if pgo_build
      ...
      profdata = Formula["carlocab/rpath-test/llvm-bootstrap-profdata"]
      args << "-DCMAKE_C_COMPILER=#{bootstrap.bin}/clang"
      args << "-DCMAKE_CXX_COMPILER=#{bootstrap.bin}/clang++"
      args << "-DLLVM_PROFDATA_FILE=#{profdata.pkgshare}/pgo_profile.prof"
    end
